# Jogo da batalha naval - aluno: Guilherme Carneiro
...
while pontos1 < pontos_necessarios or pontos2 < pontos_necessarios:
    while not jogada:
        ...
        if tiro_linha > dimensao - 1 or tiro_coluna > dimensao - 1:
            ...
            if matriz[tiro_linha][tiro_coluna] == " @ " or matriz[tiro_linha][tiro_coluna] == " * " or matriz[tiro_linha][tiro_coluna] == " ~ " or matriz[tiro_linha][tiro_coluna] == " X ":
